# Plan de Contenido: Clase 7 - Introducción a Pandas & Estructura de DataFrames
...
*   **Instagram (Stories):**
    *   [ ] Foto o captura de tu pantalla analizando un dataset real y cotidiano (ej. datos de Airbnb o Spotify): *"Hoy analizamos datos reales de [Spotify/Airbnb] en clase. ¿Qué canción crees que dominó las listas este año?"* (Encuesta con opciones reales).
    *   [ ] Mostrar capturas de alumnos asombrados por descubrir patrones en datasets reales.
*   **LinkedIn:**
    *   [ ] Artículo corto o carrusel: *"Las 4 funciones de diagnóstico rápido que aplico al recibir cualquier base de datos (`.head()`, `.info()`, `.describe()`, `.shape`)"*.
*   **TikTok:**
    *   [ ] Humor: *"Cuando te pasan un Excel de 500,000 filas y se te tilda la computadora"* vs. *"Yo abriéndolo con Pandas en 1 segundo: `import pandas as pd`"*.
