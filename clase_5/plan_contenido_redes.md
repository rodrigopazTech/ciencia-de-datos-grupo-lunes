# Plan de Contenido: Clase 5 - Modularidad de Código y Entorno Local (Jupyter Lab)
...
*   **Instagram (Stories):**
    *   [ ] Foto de tu setup nocturno con Jupyter Lab abierto en pantalla: *"Mudar a los alumnos al entorno local profesional es el primer paso para que se sientan verdaderos desarrolladores. No más simuladores."*
    *   [ ] Frase motivacional sobre la consistencia en el estudio.
*   **LinkedIn:**
    *   [ ] Post con reflexiones sobre por qué los Data Scientists aman Jupyter y cómo las funciones (`def`) ayudan a crear código de producción reutilizable.
*   **TikTok:**
    *   [ ] Video humorístico/tutorial sobre los típicos problemas instalando Anaconda y cómo no morir en el intento con las variables de entorno.
